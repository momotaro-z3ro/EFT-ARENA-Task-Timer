...
class ARENAGroup(discord.app_commands.Group):
    ...
    @discord.app_commands.describe(
        ...
        cat1="タスク1のカテゴリ(任意)", task1="タスク1のメモ(任意)", 
        cat2="タスク2のカテゴリ(任意)", task2="タスク2のメモ(任意)", 
        cat3="タスク3のカテゴリ(任意)", task3="タスク3のメモ(任意)"
    )
    @discord.app_commands.choices(task_type=[
        discord.app_commands.Choice(name="デイリー", value="daily"),
        discord.app_commands.Choice(name="ウィークリー", value="weekly")
    ...
    async def about_task(self, interaction: discord.Interaction, task_type: str, cat1: str = None, task1: str = None, cat2: str = None, task2: str = None, cat3: str = None, task3: str = None):
        await interaction.response.defer(ephemeral=True)
